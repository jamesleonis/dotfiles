_lein_completion() {
    ...
    tasks="check classpath clean compile deploy deps help install jar javac new pom repl retest run search swank test test-refresh trampoline try uberjar upgrade version with-profile"
